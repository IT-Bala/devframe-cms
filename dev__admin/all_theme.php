...
<?php
    $delete_theme='';
	$option = (admin::active_theme($theme_name)==1) ? '<span style="color:darkgreen;">RUNNING</span>' : '<a href="Javascript:activate('."'$theme_name'".');">Activate</a>';
	
	$edit_theme = (in_array($PLUG[0], $read_plug))? '<a href="edit_plugin.php?Plugins&plug='.$PLUG[0].'">Edit</a>' : '';	
	if(admin::active_theme($theme_name)!=1){
